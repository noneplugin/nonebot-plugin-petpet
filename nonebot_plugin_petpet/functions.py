...
def applaud(img: BuildImage = UserImg(), arg: str = Arg()):
    img = img.convert("RGBA").resize((110, 110))
    frames: List[IMG] = []
    locs = [
        (109,102,27,17),
        (107,105,28,15),
...
def chase_train(img: BuildImage = UserImg(), arg: str = Arg()):
    img = img.convert("RGBA").resize((42,42))
    frames: List[IMG] = []
    locs = [
        (35,34,128,44),
        (35,33,132,40),
