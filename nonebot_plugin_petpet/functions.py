...
def avatar_formula(img: BuildImage = UserImg(), arg=NoArg()):
    ...
    img_c = img.convert("RGBA").circle().resize((72, 72), keep_ratio=True)
    img_tp = img.convert("RGBA").circle().resize((51, 51), keep_ratio=True)
    frame.paste(img_tp,(948,247))
    frames: List[IMG] = []
    locs = [
        (143,32),(155,148),(334,149),(275,266),
        (486,266),(258,383),(439,382),(343,539),
        (577,487),(296,717),(535,717),(64,896),
        (340,896),(578,897),(210,1038),(644,1039),
        (64,1192),(460,1192),(698,1192),(1036,141),
        (1217,141),(1243,263),(1140,378),(1321,378),
        (929,531),(1325,531),(1592,531),(1007,687),
        (1390,687),(1631,686),(1036,840),(1209,839),
        (1447,839),(1141,1018),(1309,1019),(1546,1019),
        (1037,1197),(1317,1198),(1555,1197),
    ]
    for i in range(39):
        x, y = locs[i]
